...
describe Webhookr::Friendbuy::Adapter do
  ...
  describe "the class" do
    ...
    subject { Webhookr::Friendbuy::Adapter }
  ...
  describe "the instance" do
    ...
    subject { Webhookr::Friendbuy::Adapter.new }
  ...
  describe "it's response" do
    before do
      @event_type = "unsubscribe"
      @adapter = Webhookr::Friendbuy::Adapter.new
    end
    ...
    it "should return the correct service name" do
      assert_equal(Webhookr::Friendbuy::Adapter::SERVICE_NAME, subject.service_name)
    end
